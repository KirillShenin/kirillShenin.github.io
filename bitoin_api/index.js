...
function showFirstValueOnScreenLoad(results) {
   ...
   $(`.firstValue`).text("Текущая стоимость биткойнa: $" + firstValue.toFixed(2));
...
function showHistoricData(results) {
   ...
   $('.difference').text("Разница в стоимости Bitcoin'а для выбранных дат составляет: $" + difference.toFixed(2));
}
